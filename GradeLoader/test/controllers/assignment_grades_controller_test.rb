...
class AssignmentGradesControllerTest < ActionController::TestCase
  ...
  test "should create assignment_grade" do
    assert_difference('AssignmentGrade.count') do
      post :create, assignment_grade: { course_id: @assignment_grade.course_id, letter_grade: @assignment_grade.letter_grade, name: @assignment_grade.name, percent_grade: @assignment_grade.percent_grade, student_id: @assignment_grade.student_id }
    end
  ...
  test "should update assignment_grade" do
    patch :update, id: @assignment_grade, assignment_grade: { course_id: @assignment_grade.course_id, letter_grade: @assignment_grade.letter_grade, name: @assignment_grade.name, percent_grade: @assignment_grade.percent_grade, student_id: @assignment_grade.student_id }
    assert_redirected_to assignment_grade_path(assigns(:assignment_grade))
  end
